  ...
  return (
    <DayPicker
      ...
      className={cn(
        ...
        `, String.raw`rtl:**:[.rdp-button\_next>svg]:rotate-180`, String.raw`
      ...
      classNames={{
        ...
        dropdown_root: cn(
          `
            ...
            relative rounded-md border shadow-xs
            has-focus:ring-[3px]
        ...
        caption_label: cn(
          'font-medium select-none', captionLayout === 'label' ?
            'text-sm' :
            `
        ...
        week_number_header: cn(
          'w-(--cell-size) select-none', defaultClassNames.week_number_header
        ),
        week_number: cn(
          'text-muted-foreground text-[0.8rem] select-none', defaultClassNames.week_number
        ),
        day: cn(
          `
        ...
        range_start: cn(
          'bg-accent rounded-l-md', defaultClassNames.range_start
        ),
