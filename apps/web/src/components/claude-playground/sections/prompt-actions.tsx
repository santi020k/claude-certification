    ...
    <div className="flex w-full flex-col gap-3">
      <div className="flex w-full gap-2.5">
        ...
        <Button
          ...
          className="
            flex-1 gap-2 border-white/10 bg-white/4 transition-all duration-200
...
>) {
  if (retryAfter !== null) {
    return (
      <span
        className="flex items-center gap-1.5 font-mono text-rose-400/80"
      >
        <span
          className="
  ...
  if (isLimited) {
    return (
      <span
        className="flex items-center gap-1.5 font-mono text-amber-400/80"
      >
        <span
          className="
