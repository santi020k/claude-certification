...
export function ChatPage() {
  ...
  const currentUiConfig =
    SPECIALIST_UI[specialistId] ?? SPECIALIST_UI["general"]!;
        ...
        <header className="animate-fade-in grid gap-5 lg:grid-cols-[1fr_auto]">
          ...
          <div className="flex w-full flex-col gap-1.5 rounded-xl border border-white/10 bg-black/20 p-3 backdrop-blur-sm lg:w-56">
            <div className="flex items-center justify-between gap-2">
              ...
              <span className={`text-xs font-semibold ${tl.colour}`}>
                {tl.label}
              </span>
            </div>
            <input
          ...
          <div className="flex flex-wrap items-center justify-between gap-3 border-b border-white/8 bg-black/15 px-4 py-3">
            ...
            <div className="flex items-center gap-2 sm:gap-3">
              ...
              <Button
                ...
                variant="outline"
                size="sm"
                className="border-white/15 bg-white/4 transition-all hover:-translate-y-0.5 hover:border-orange-200/30 text-xs gap-1.5 h-8"
                onClick={() => {
                  resetChat();
                }}
              >
          ...
          >
            ...
            <div className="flex flex-wrap items-center justify-between gap-3">
              ...
              <div className="flex flex-wrap items-center gap-3">
                <label
                  className="flex items-center gap-2 text-xs text-muted-foreground focus-within:text-foreground"
